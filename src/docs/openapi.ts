...
function jsonBody(description = "Request body", example?: unknown) {
  return {
    required: true,
    content: {
      "application/json": {
...
const foPaths = mergePaths(
  ...
  crudPaths(`${foBase}/masters/market-segments`, "FO · Masters", "market segments", { idPrefix: "MS" }),
...
const fbPaths = mergePaths(
  ...
  crudPaths(`${fbBase}/menu/categories`, "FB · Menu", "menu categories", { idPrefix: "MC" }),
  crudPaths(`${fbBase}/menu/items`, "FB · Menu", "menu items", {
    idPrefix: "MI",
    listQuery: [outletQ],
  }),
  crudPaths(`${fbBase}/menu/modifiers`, "FB · Menu", "modifiers", { idPrefix: "MOD" }),
  crudPaths(`${fbBase}/menu/combos`, "FB · Menu", "combos", { idPrefix: "CMB" }),
  crudPaths(`${fbBase}/menu/pricing`, "FB · Menu", "pricing rules", {
    idPrefix: "PR",
    listQuery: [outletQ],
  }),
  crudPaths(`${fbBase}/banquet/bookings`, "FB · Banquet", "banquet bookings", { idPrefix: "BB" }),
  crudPaths(`${fbBase}/banquet/packages`, "FB · Banquet", "banquet packages", { idPrefix: "BP" }),
  crudPaths(`${fbBase}/banquet/requirements`, "FB · Banquet", "banquet requirements", {
    idPrefix: "BR",
    listQuery: [outletQ],
  }),
  ...
  crudPaths(`${fbBase}/inventory/suppliers`, "FB · Inventory", "suppliers", { idPrefix: "SUP" }),
  crudPaths(`${fbBase}/inventory/purchase-orders`, "FB · Inventory", "purchase orders", {
    idPrefix: "PO",
  }),
  crudPaths(`${fbBase}/inventory/grn`, "FB · Inventory", "GRN records", { idPrefix: "GRN" }),
  crudPaths(`${fbBase}/inventory/stock-movements`, "FB · Inventory", "stock movements", {
    idPrefix: "SM",
  }),
  crudPaths(`${fbBase}/inventory/wastage`, "FB · Inventory", "wastage records", { idPrefix: "WST" }),
  crudPaths(`${fbBase}/inventory/stock-counts`, "FB · Inventory", "stock counts", { idPrefix: "SC" }),
  crudPaths(`${fbBase}/inventory/adjustments`, "FB · Inventory", "stock adjustments", {
    idPrefix: "ADJ",
  }),
  crudPaths(`${fbBase}/bar/drink-categories`, "FB · Bar", "drink categories", { idPrefix: "DC" }),
  crudPaths(`${fbBase}/bar/drinks`, "FB · Bar", "drinks", { idPrefix: "DR", listQuery: [outletQ] }),
  crudPaths(`${fbBase}/bar/cocktails`, "FB · Bar", "cocktails", { idPrefix: "CK" }),
  crudPaths(`${fbBase}/bar/happy-hour`, "FB · Bar", "happy-hour rules", {
    idPrefix: "HH",
    listQuery: [outletQ],
  }),
  ...
  crudPaths(`${fbBase}/settings/taxes`, "FB · Settings", "taxes", { idPrefix: "TX" }),
  crudPaths(`${fbBase}/settings/discounts`, "FB · Settings", "discounts", { idPrefix: "DSC" }),
  crudPaths(`${fbBase}/settings/payment-modes`, "FB · Settings", "payment modes", { idPrefix: "PM" }),
  crudPaths(`${fbBase}/settings/order-types`, "FB · Settings", "order types", { idPrefix: "OT" }),
  crudPaths(`${fbBase}/day-close`, "FB · Settings", "day close records", {
    idPrefix: "DC",
    listQuery: [outletQ],
  }),
  {
