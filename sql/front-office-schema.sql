...
create table if not exists rooms (
  ...
  maintenance text not null default 'OK',
  checkout_date text,
  created_at timestamptz default now()
);
...
insert into rooms (room_no, room_type, floor, status, guest_name, housekeeping, maintenance, checkout_date) values
  ('101','Standard','1st Floor','Occupied','James Wilson','Clean','OK','27 Jun'),
  ('102','Standard','1st Floor','Vacant',null,'Clean','OK',null),
  ('103','Deluxe','1st Floor','Dirty',null,'Dirty','OK',null),
  ('104','Deluxe','1st Floor','Maintenance',null,'Clean','In Progress',null),
  ('105','Standard','1st Floor','Blocked',null,'Clean','OK',null),
  ('112','Standard','1st Floor','Occupied','James Wilson','Clean','OK','27 Jun'),
  ('204','Deluxe','2nd Floor','Occupied','Rahul Sharma','Clean','OK','26 Jun'),
  ('305','Deluxe','3rd Floor','Occupied','Michael Brown','Clean','OK','24 Jun'),
  ('308','Deluxe','3rd Floor','Vacant',null,'Clean','OK',null),
  ('501','Suite','5th Floor','Occupied','Priya Patel','Clean','OK','27 Jun'),
  ('602','Suite','6th Floor','Vacant',null,'Clean','OK',null)
on conflict (room_no) do nothing;

insert into guests (id, name, mobile, email, nationality, total_stays, loyalty_points, id_type, id_number, member_since) values
  ('G-001','Rahul Sharma','+91 98765 43210','rahul@email.com','Indian',5,1200,'Aadhaar','XXXX-XXXX-4521','2024-01-15'),
  ('G-002','James Wilson','+91 87654 32109','james.w@email.com','British',3,800,'Passport','GB9823412','2024-06-01'),
  ('G-003','Anita Desai','+91 76543 21098','anita.d@email.com','Indian',2,400,'Driving Licence','DL-MH-2019-8821','2025-02-10'),
  ('G-004','Priya Patel','+91 99887 76655','priya@email.com','Indian',8,2500,'Aadhaar','XXXX-XXXX-8899','2023-08-20'),
...
insert into reservations (id, guest_name, guest_id, phone, email, source, room_no, room_type, check_in, check_out, balance, status, arriving_today, nationality, id_proof_type, id_number, adults, children, nights, tariff_plan, meal_plan, room_rate, total_amount, advance_paid, payment_mode, special_requests, created_at, booked_by, restaurant_bill, laundry, is_vip) values
  ...
  ('BK-1041','Priya Patel','G-004','+91 99887 76655','priya@email.com','Corporate','501','Suite','22 Jun 2026','27 Jun 2026',12400,'Checked In',false,'Indian','Aadhaar','XXXX-XXXX-8899',2,1,5,'CORP','MAP',8500,42500,30100,'Card',null,'15 Jun 2026, 9:00 AM','Sales — Neha',1200,450,true),
  ('BK-1038','Michael Brown','G-005','+91 88776 65544','m.brown@corp.com','Corporate','305','Deluxe','21 Jun 2026','24 Jun 2026',5600,'Checked In',false,'American','Passport','US4412299',1,0,3,'CORP','CP',4200,12600,7000,'Card',null,'19 Jun 2026, 3:00 PM','Front Desk — Amit',940,320,true),
  ('BK-1043','Sneha Reddy',null,'+91 91234 56789','sneha.r@email.com','MakeMyTrip','102','Standard','24 Jun 2026','26 Jun 2026',6400,'Confirmed',true,'Indian',null,null,2,0,2,'OTA','EP',3200,6400,0,'Pay at Hotel',null,'22 Jun 2026, 1:00 PM','Online — MMT',0,0,false)
on conflict (id) do nothing;

insert into folio_entries (id, guest_name, room, reservation_id, date, description, category, debit, credit, balance) values
  ('FE-01','James Wilson','112','BK-1040','22 Jun 2026','Room Charge — Night 1','Room',3200,0,3200),
  ('FE-02','James Wilson','112','BK-1040','22 Jun 2026','Advance Payment','Payment',0,12800,-9600),
  ('FE-03','James Wilson','112','BK-1040','23 Jun 2026','Restaurant — Dinner','Restaurant',850,0,-8750),
  ('FE-04','Rahul Sharma','204','BK-1042','23 Jun 2026','Room Charge — Night 1','Room',4500,0,4500),
  ('FE-05','Rahul Sharma','204','BK-1042','23 Jun 2026','Advance Payment','Payment',0,5000,-500)
on conflict (id) do nothing;

insert into payments (id, guest_name, room, reservation_id, amount, mode, type, transaction_no, date, status) values
  ('PAY-01','James Wilson','112','BK-1040',12800,'Card','Advance','TXN-8821','18 Jun 2026','Completed'),
  ('PAY-02','Rahul Sharma','204','BK-1042',5000,'UPI','Advance','TXN-8822','20 Jun 2026','Completed'),
  ('PAY-03','Priya Patel','501','BK-1041',30100,'Card','Advance','TXN-8823','15 Jun 2026','Completed')
on conflict (id) do nothing;
