...
insert into hr_employees (id, property_id, emp_code, first_name, last_name, email, phone, department_id, designation_id, employment_type_id, shift_type_id, leave_policy_id, join_date, status, gender, avatar, attendance_rate, leave_balance) values
  ('k2000001-0001-4000-8000-000000000001', 'prop-grand-palace', 'EMP-0101', 'Rajesh', 'Kumar', 'rajesh.kumar@grandpalace.com', '+91 98765 43210', 'a1000001-0001-4000-8000-000000000001', 'b2000001-0001-4000-8000-000000000001', 'c3000001-0001-4000-8000-000000000001', 'd4000001-0001-4000-8000-000000000001', 'f6000001-0001-4000-8000-000000000002', '2026-09-01', 'Active', 'Male', 'RK', 100.0, '{"casual":8,"sick":7,"earned":14}'::jsonb),
  ('k2000001-0001-4000-8000-000000000002', 'prop-grand-palace', 'EMP-0102', 'Priya', 'Patel', 'priya.patel@grandpalace.com', '+91 98765 43211', 'a1000001-0001-4000-8000-000000000001', 'b2000001-0001-4000-8000-000000000002', 'c3000001-0001-4000-8000-000000000001', 'd4000001-0001-4000-8000-000000000002', 'f6000001-0001-4000-8000-000000000001', '2026-09-02', 'Active', 'Female', 'PP', 75.0, '{"casual":6,"sick":8,"earned":10}'::jsonb),
  ('k2000001-0001-4000-8000-000000000003', 'prop-grand-palace', 'EMP-0103', 'Anjali', 'Sharma', 'anjali.sharma@grandpalace.com', '+91 98765 43212', 'a1000001-0001-4000-8000-000000000002', 'b2000001-0001-4000-8000-000000000003', 'c3000001-0001-4000-8000-000000000001', 'd4000001-0001-4000-8000-000000000001', 'f6000001-0001-4000-8000-000000000002', '2026-09-03', 'Active', 'Female', 'AS', 100.0, '{"casual":10,"sick":9,"earned":16}'::jsonb),
  ('k2000001-0001-4000-8000-000000000004', 'prop-grand-palace', 'EMP-0104', 'Vikramjit', 'Singh', 'vikram@grandpalace.com', '+91 98765 43213', 'a1000001-0001-4000-8000-000000000003', 'b2000001-0001-4000-8000-000000000004', 'c3000001-0001-4000-8000-000000000001', 'd4000001-0001-4000-8000-000000000002', 'f6000001-0001-4000-8000-000000000002', '2026-09-04', 'Active', 'Male', 'VS', 100.0, '{"casual":11,"sick":10,"earned":20}'::jsonb),
  ('k2000001-0001-4000-8000-000000000005', 'prop-grand-palace', 'EMP-0105', 'Arjun', 'Verma', 'arjun.verma@grandpalace.com', '+91 98765 43214', 'a1000001-0001-4000-8000-000000000003', 'b2000001-0001-4000-8000-000000000005', 'c3000001-0001-4000-8000-000000000003', 'd4000001-0001-4000-8000-000000000002', 'f6000001-0001-4000-8000-000000000001', '2026-09-05', 'Active', 'Male', 'AV', 100.0, '{"casual":12,"sick":10,"earned":0}'::jsonb)
