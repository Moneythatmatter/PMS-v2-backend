...
export function isRoomChargePayment(method) {
...
export async function syncRoomServiceAfterCancellationViaRpc(input) {
    const { data, error } = await supabase.rpc("fnb_sync_room_service_after_cancellation", {
        p_bill_id: input.billId,
        p_order_id: input.orderId,
...
//# sourceMappingURL=fnb-folio-sync.service.js.map