...
export function withMntDocumentDefaults(body, options) {
    const out = { ...body };
...
export function packMntDocument(body, options) {
    const payload = { ...body };
...
export function unpackMntDocument(row) {
    const r = row;
...
//# sourceMappingURL=maintenance-docs.js.map