...
import { approveLeave, cancelLeave, enrichLeaveApplicationOnCreate, modifyLeave, previewLeaveDays, } from "../../services/human-resources/leave/leave-lifecycle.service.js";
...
export async function listLeaveApplications(req, res) {
    try {
...
export async function getLeaveApplication(req, res) {
    try {
...
export async function previewLeaveApplicationDays(req, res) {
    try {
        const pid = propertyId(req);
        const body = req.body;
...
export async function createLeaveApplication(req, res) {
    try {
        const pid = propertyId(req);
        const body = { ...req.body };
        if (!body.id)
...
export async function updateLeaveApplication(req, res) {
    try {
        const pid = propertyId(req);
...
export async function deleteLeaveApplication(req, res) {
    try {
...
export async function approveLeaveApplication(req, res) {
    try {
        const pid = propertyId(req);
        const id = String(req.params.id);
        const body = req.body;
...
export async function cancelLeaveApplication(req, res) {
    try {
        const pid = propertyId(req);
        const id = String(req.params.id);
        const body = req.body;
...
export async function modifyLeaveApplication(req, res) {
    try {
        const pid = propertyId(req);
        const id = String(req.params.id);
        const body = req.body;
...
//# sourceMappingURL=leave-applications.js.map