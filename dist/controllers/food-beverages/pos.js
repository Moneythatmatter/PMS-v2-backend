...
export async function getOpenTableOrder(req, res) {
    try {
...
export async function printBill(req, res) {
    try {
...
export async function printBillForOrder(req, res) {
    try {
...
export async function acceptKot(req, res) {
    try {
        const body = (req.body ?? {});
...
export async function rejectKot(req, res) {
    try {
        const body = (req.body ?? {});
...
export async function cancelKotItem(req, res) {
    try {
        const body = (req.body ?? {});
...
export async function advanceKot(req, res) {
    try {
        ...
        if (!row)
            return fail(res, "KOT not found after advance", 404);
        return ok(res, row);
    }
    catch (e) {
        return fromError(res, e);
