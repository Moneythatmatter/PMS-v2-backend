...
import { ensureSystemBookingTypes, listBookingTypes, } from "../controllers/sales-marketing/booking-types.js";
const router = Router();
...
for (const cfg of crudRoutes) {
    if (cfg.path === "/masters/booking-types")
        continue;
    const codeFields = cfg.codeFields;
    mountCrud(router, cfg.path, createTableCrud({
        table: cfg.table,
        idPrefix: cfg.prefix,
        orderBy: cfg.orderBy,
...
//# sourceMappingURL=sales-marketing.js.map